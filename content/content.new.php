<?php
	...
	Class contentExtensionDeployerNew extends AdministrationPage{
...
//			$this->_Deployer =& $this->_Parent->ExtensionManager->create('deployer');
			
			$this->setTitle('Symphony &ndash; Deployer &ndash; Untitled');
		}
...
/*					
					...
					$li->appendChild(Widget::Anchor('Return to panel', extension_deployer::baseURL() . 'deployer' . (is_array($this->_context) && !empty($this->_context) ? implode('/', $this->_context) . '/' : NULL), 'Return', 'button create'));
